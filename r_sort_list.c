...
Pchain r_insert(Pchain pliste, int e, int sleep,float  temp){    //insertion of element in the list(ascending)
...
int r_sort_list(char **argv){                           //sort with an ascending list 
    Pchain list=NULL;
